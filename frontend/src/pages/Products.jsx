...
const Products = () => {
    ...
    return (
        <div className="flex flex-col min-h-screen">
            {/* Hero Header Image */}
            <div className="relative w-full h-[220px] md:h-[300px] bg-background-dark overflow-hidden">
                <div
                ...
                <div className="relative h-full max-w-[1440px] mx-auto px-6 md:px-10 flex flex-col justify-end pb-8 animate-fade-in-up">
            ...
            <div className="flex-1 w-full max-w-[1440px] mx-auto flex flex-col lg:flex-row gap-8 px-4 md:px-10 py-8">
                {/* Sidebar Filters */}
                    ...
                    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <div className="relative group">
                                <select
                                    className="appearance-none bg-surface-dark border border-[#28392e] text-white text-sm rounded-lg px-4 py-2 pr-8 focus:outline-none focus:border-secondary cursor-pointer font-sans min-w-[160px]"
                                    value={sortBy}
