        ...
        <>
            ...
            <section className="relative w-full h-[600px] md:h-[700px] bg-background-dark overflow-hidden group">
                ...
                <button
                    ...
                    className="absolute left-4 top-1/2 -translate-y-1/2 z-10 text-background-dark p-3 rounded-full shadow-lg transition-colors"
                >
                ...
                <button
                    ...
                    className="absolute right-4 top-1/2 -translate-y-1/2 z-10 text-background-dark p-3 rounded-full shadow-lg transition-colors"
                >
