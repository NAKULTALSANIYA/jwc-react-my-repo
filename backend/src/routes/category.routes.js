...
router.post('/', authenticate, isManager, upload.single('imageFile'), CategoryController.createCategory);
...
router.put('/:id', authenticate, isManager, upload.single('imageFile'), CategoryController.updateCategory);
